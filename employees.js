...
const Sarah = new Employee('Sarah Lattlin',['Mon ','Tues ','Thurs ','Sat '])
console.log(Sarah)
/*
...
class Manager extends Employee {
    ...
    getEmployees() {
        console.log(`${this.name}'s employees are ${this.employees}`)
    }
...
const matt = new Manager ('Matt Kiefer','Mon-Sat',['Adin', ' Olivia',' Jess'])
console.log(matt)
